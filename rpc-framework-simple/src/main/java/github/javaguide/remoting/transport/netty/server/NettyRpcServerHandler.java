 ...
 *
 * <p>如果继承自 SimpleChannelInboundHandler 的话就不要考虑 ByteBuf 的释放 ，{@link SimpleChannelInboundHandler} 内部的
    ...
    try {
      if (msg instanceof RpcMessage) {
        ...
        if (messageType == RpcConstants.HEARTBEAT_REQUEST_TYPE) {
          ...
          // Execute the target method (the method the client needs to execute) and return the
          // method result
